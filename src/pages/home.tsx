      ...
      <div className="w-full max-w-[430px] flex-1 flex flex-col relative z-10 px-6 py-12 justify-between">
        ...
        <main className="flex-1 flex flex-col justify-center mt-12 mb-16">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <Button asChild size="lg" className="w-full h-14 text-lg font-semibold rounded-2xl shadow-lg shadow-primary/25 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300" data-testid="button-get-started">
              <Link to="/login">
                Get Started
